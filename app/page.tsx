...
export default function Home() {
  ...
  const generateRAMS = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Log error for you, but keep UI running
  ...
  const createPDF = (apiData: any) => {
    ...
    // 4. RISK ASSESSMENT (Fixed Widths for MEDIUM/HIGH)
    checkPageBreak(80);
    ...
    autoTable(doc, {
        ...
        columnStyles: { 
            ...
            1: { cellWidth: 35 }, 
            2: { cellWidth: 20 }, 
            3: { cellWidth: 25, halign: 'center' }, // INCREASED TO 25
            4: { cellWidth: 'auto' }, 
            5: { cellWidth: 25, halign: 'center' }  // INCREASED TO 25
        },
        // @ts-ignore
    ...
    const methodSteps = apiData.method_steps || [{ t: "5.1 PRE-START", d: "Arrive on site." }, { t: "5.2 SAFETY", d: "Secure area." }, { t: "5.3 EXECUTION", d: `Carry out ${formData.jobType}.` }, { t: "5.4 COMPLETION", d: "Handover." }];
    ...
    autoTable(doc, { startY: currentY, head: [['Item', 'Requirement Status']], body: [['Safety Boots', 'Mandatory'], ['Gloves', 'Mandatory'], ['Eye Protection', 'Task Dependent']], theme: 'grid', headStyles: { fillColor: [230,230,230], textColor: 0 }, styles: { fontSize: 9, lineColor: 0, lineWidth: 0.1 } });
    // @ts-ignore
    ...
    doc.setFontSize(10); doc.setFont("helvetica", "normal"); doc.text("I confirm I have read this RAMS.", margin, currentY); currentY += 10;
    doc.setDrawColor(0); doc.rect(margin, currentY, contentWidth, 40);
    doc.text("Signed: __________________________", margin + 5, currentY + 30);
