        ...
        <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                >
                    ...
                    <span className="font-racing text-4xl tracking-tight inline-block bg-clip-text text-transparent bg-[linear-gradient(90deg,#000000,#0f172a,#450a0a,#000000,#0f172a,#450a0a,#000000)] bg-[length:200%_auto] animate-wave pr-2 pb-1">
                        RAMS Sorted
                    </span>
                    <style jsx global>{`
                        @keyframes wave {
